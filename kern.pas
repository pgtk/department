...
const
BASE_REPO         = '\\MATRIX\Base$\departments\newdep.exe';
MARK_REPO         = '\\MATRIX\Base$\marketing\marketing.exe';
DIR_REPO          = '\\MATRIX\Base$\director\director.exe';
...
function GetNewDateDay(const date: TDate): string;
function GetNewDateMonth(const date: TDate): string;
function GetNewDateYear(const date: TDate): string;
